...
const DeveloperStatisticsContent = dynamic(() => import('../../components/DeveloperStatisticsContent'), { ssr: false });

export default function ProtectedDeveloperStatisticsPage() {
  ...
  return <DeveloperStatisticsContent />;
}
